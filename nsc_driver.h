...
uint32_t V2FIsControllerBusy(V2FMCRegisters* dev);
void V2FResetSync(V2FMCRegisters* dev, int way);
void V2FSetFeaturesSync(V2FMCRegisters* dev, int way, uint32_t feature0x02, uint32_t feature0x10, uint32_t feature0x01, uint32_t payLoadAddr);
void V2FGetFeaturesSync(V2FMCRegisters* dev, int way, uint32_t* feature0x01, uint32_t* feature0x02, uint32_t* feature0x10, uint32_t* feature0x30);
void V2FReadPageTriggerAsync(V2FMCRegisters* dev, int way, uint32_t rowAddress);
void V2FReadPageTransferAsync(V2FMCRegisters* dev, int way, void* pageDataBuffer, void* spareDataBuffer, uint32_t* errorInformation, uint32_t* completion, uint32_t rowAddress);
void V2FReadPageTransferRawAsync(V2FMCRegisters* dev, int way, void* pageDataBuffer, uint32_t* completion);
void V2FProgramPageAsync(V2FMCRegisters* dev, int way, uint32_t rowAddress, void* pageDataBuffer, void* spareDataBuffer);
void V2FEraseBlockAsync(V2FMCRegisters* dev, int way, uint32_t rowAddress);
void V2FStatusCheckAsync(V2FMCRegisters* dev, int way, uint32_t* statusReport);
uint32_t V2FStatusCheckSync(V2FMCRegisters* dev, int way);
uint32_t V2FReadyBusyAsync(V2FMCRegisters* dev);
