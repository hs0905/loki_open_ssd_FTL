...
#define STATUS_REPORT_TABLE_ADDR			(COMPLETE_FLAG_TABLE_ADDR + sizeof(COMPLETE_FLAG_TABLE)) // 0x17000000 + 0x100 = 0x17000100
#define ERROR_INFO_TABLE_ADDR				(STATUS_REPORT_TABLE_ADDR + sizeof(STATUS_REPORT_TABLE)) // 0x17000100 + 0x100 = 0x17000200
#define TEMPORARY_PAY_LOAD_ADDR				(ERROR_INFO_TABLE_ADDR+ sizeof(ERROR_INFO_TABLE)) // 0x17000200 + 0xB00 =0x17000D00
...
// #define REQ_POOL_ADDR						0x17E00000

// for dependency table
#define ROW_ADDR_DEPENDENCY_TABLE_ADDR		(REQ_POOL_ADDR + sizeof(REQ_POOL))
// #define ROW_ADDR_DEPENDENCY_TABLE_ADDR		(GC_VICTIM_MAP_ADDR + sizeof(GC_VICTIM_MAP))
