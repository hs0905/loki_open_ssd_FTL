...
#define ADMIN_CMD_DRAM_DATA_BUFFER		0x16000000
...
#define ERROR_INJECTION_TIMING								
#define ERROR_INJECTION										0x44
...
typedef struct _ADMIN_IDENTIFY_CONTROLLER
{
	...
	struct
	{
		uint32_t supportsSGL								:1;
		uint32_t reserved0									:15;
		uint32_t supportsSGLBitBucketDescriptor				:1;
...
typedef struct _DATASET_MANAGEMENT_RANGE
{
	...
	uint32_t lengthInLogicalBlocks;
	uint32_t startingLBA[2];
